			...
			<form action="" id="frm" name="frm" method="post" style="left: 30px">
				...
				<div id="background_box" style="height: 140%; width: 80%">
					...
					<div
						...
						<img id="previewMainImg"
							src="http://localhost/retro_prj/upload/${ productOne.img }"
					...
					<div
						...
						<input type="text"
							...
							value="${ productOne.id } ( ${ productOne.nickname } ) "
							readonly="readonly">
					</div>
					<div
						...
						<input type="text"
							style="border: 0px solid white; border-bottom: 1px solid #ccc; height: 40px; width: 500px"
							value="${ productOne.category } > ${ productOne.category2 } > ${ productOne.category3 }"
							readonly="readonly">
					</div>
					<div
